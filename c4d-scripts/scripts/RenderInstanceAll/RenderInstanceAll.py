#make all instances render instances
#2017-05-17
#Modified from
...
"""
Name-US:RenderInstanceAll
Description-US:Make all Instances Render Instances
 (SHIFT-CLICK: for adding ' Instance')
...
def main():
    ...
    for x in GetAllObjects(doc):
        if x.GetType()==c4d.Oinstance and x[c4d.INSTANCEOBJECT_LINK]!=None:
            ...
            x.SetName(refname)
            x[c4d.INSTANCEOBJECT_RENDERINSTANCE]=True
