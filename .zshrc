...
export ZSH=/Users/maly/.oh-my-zsh
...
gs                                         \
  ...
  -dColorImageResolution="$compres"               \
  -dGrayImageResolution="$compres"                \
  -dMonoImageResolution="$compres"                 \
...
echo "pdfshrink() available"
export OCIO=/Users/maly/Documents/filmic-blender-master/config.ocio
source ~/.zsh_functions/cdf
echo "cdf() available"
